...
export default function App() {
    ...
    const handleLogin = (newToken: string, userData: User) => {
        ...
        setActiveTab('feed');
        console.log('App: State updated:', { currentScreen: 'journals', activeTab: 'feed' });
    };
            ...
            case 'account':
                return (
                    <View style={styles.mainContainer}>
                        ...
                        {currentScreen === 'journal' && <JournalEditScreen onBack={() => handleTabPress('feed')} token={token} />}
                        {currentScreen === 'account' && <AccountScreen onEdit={() => handleTabPress('plus')} onLogout={handleLogout} user={user} />}
